...
All data of the CPS1000 cohort is stored in /data/CPS1000_data.RData. The analysis scripts can be found under vignettes/src/CPS1000_Analysis.Rmd with the associated .html files.

For the validation cohort (EMBL2016) data are stored in /data/EMBL2016_data.RData. Analysis scripts are stored under vignettes/src/EMBL2016_Analysis.Rmd along with the associated .html files.
...
Output 
The CPS1000 analysis script takes roughly ... minutes to run, mostly due to the ... The expected output is shown in vignettes/src/CPS1000_Analysis.html and vignettes/src/EMBL2016_Analysis.html.
