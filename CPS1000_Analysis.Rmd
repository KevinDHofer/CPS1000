...
#save
saveRDS(fgsea_hallmark, paste0(filepath,"data/", "fgsea_hallmark.rds"))
...
Y <- c()
for (i in colnames(countData_knis)) {
  ifelse(i %in% ddx3x_knis, Y <- append(Y, "mutated"), Y <- append(Y,"unmutated"))
}
condition_knis <- factor(Y)
...
#save
saveRDS(fgsea_hallmark_knis, paste0(filepath,"data/", "fgsea_hallmark_knis.rds"))
