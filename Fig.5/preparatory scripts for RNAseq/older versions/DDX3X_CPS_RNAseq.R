...
#write_csv(fgsea_hallmark, "fgsea_hallmark_baseline.csv")
...
#saveRDS(fgsea_hallmark_df_cps, "fgsea_hallmark_df_cps.rds")

topPathways_hallmark_clean <- fgsea_hallmark_df_cps$pathway[1:10]

#ggplot2
plot_fgsea_h <- fgsea_hallmark_df_cps[1:10,] |> filter(padj <0.1) |> 
...
fgsea_KEGG_df_cps$pathway <- gsub("KEGG_", "", fgsea_KEGG_df_cps$pathway)
#saveRDS(fgsea_KEGG_df_cps, "fgsea_KEGG_df_cps.rds")

topPathways_KEGG_clean_cps <- fgsea_KEGG_df_cps$pathway[1:10]

# plot top10 for GO
plot_fgsea_kegg <- fgsea_KEGG_df_cps |> filter(pathway %in% topPathways_KEGG_clean_cps) |> 
