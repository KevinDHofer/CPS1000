...
FigS12 <- ggdraw(FigS12) +
  draw_label("Supplementary Figure 12", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
...
ft_grob <- gen_grob(stab3, fit = "auto", scaling = "min", hjust = 0)
...
TabS3 <- ggdraw(TabS3) +
  draw_label("Supplementary Table 3", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
...
Fig2 <- ggdraw(Fig2) +
  draw_label("Figure 2", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS1 <- ggdraw(FigS1) +
  draw_label("Supplementary Figure 1", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS2 <- ggdraw(FigS2) +
  draw_label("Supplementary Figure 2", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS3 <- ggdraw(FigS3) +
  draw_label("Supplementary Figure 3", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS4 <- ggdraw(FigS4) +
  draw_label("Supplementary Figure 4", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
Fig3 <- ggdraw(Fig3) +
  draw_label("Figure 3", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS5 <- ggdraw(FigS5) +
  draw_label("Supplementary Figure 5", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS6 <- ggdraw(FigS6) +
  draw_label("Supplementary Figure 6", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
#multipanel
#Fig4
row4 <- plot_grid(Fig4, NULL, ncol = 2, rel_widths = c(0.975, 0.025))

Fig4 <- plot_grid(Fig4, NULL, nrow = 2, rel_heights = c(0.2, 0.8))

Fig4 <- ggdraw(Fig4) +
  draw_label("Figure 4", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS7 <- ggdraw(FigS7) +
  draw_label("Supplementary Figure 7", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
Fig5 <- ggdraw(Fig5) +
  draw_label("Figure 5", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS8 <- ggdraw(FigS8) +
  draw_label("Supplementary Figure 8", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
Fig6 <- ggdraw(Fig6) +
  draw_label("Figure 6", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS9 <- ggdraw(FigS9) +
  draw_label("Supplementary Figure 9", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
Fig7 <- ggdraw(Fig7) +
  draw_label("Figure 7", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS10 <- ggdraw(FigS10) +
  draw_label("Supplementary Figure 10", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
FigS11 <- ggdraw(FigS11) +
  draw_label("Supplementary Figure 11", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 14, fontface = "bold")
...
```{r}
stable1 <- read_excel((paste0(filepath,"data/supp_tables.xlsx")), sheet = "S1_drug_concentrations")
...
ft <- ft |> 
  ...
  flextable::align(j = 2:ncol(stable1), align = "center", part = "body") |>  # Numeric columns centered, not right
  ...
  flextable::width(j=2:ncol(stable1), width = 1) |>  # Adjust as needed
...
TabS1 <- ggdraw(TabS1) +
  draw_label("Supplementary Table 1", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 9, fontface = "bold")
...
```{r}
long <- read_excel((paste0(filepath,"data/supp_tables.xlsx")), sheet = "S4_regimes_longitudinal_CLL")
...
TabS4 <- ggdraw(TabS4) +
  draw_label("Supplementary Table 4", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 9, fontface = "bold")
...
```{r}
tx <- read_excel((paste0(filepath,"data/supp_tables.xlsx")), sheet = "S5_agents_treatment_CLL")
...
TabS5 <- ggdraw(TabS5) +
  draw_label("Supplementary Table 5", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 9, fontface = "bold")
...
```{r}
cll <- read_excel((paste0(filepath,"data/supp_tables.xlsx")), sheet = "S6_trials_CLL") |> 
...
TabS6 <- ggdraw(TabS6) +
  draw_label("Supplementary Table 6", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 9, fontface = "bold")
...
```{r}
aml <- read_excel((paste0(filepath,"data/supp_tables.xlsx")), sheet = "S7_trials_AML")
...
TabS7 <- ggdraw(TabS7) +
  draw_label("Supplementary Table 7", x = 0.8, y = 0.02, hjust = 0, vjust = 0,
             size = 9, fontface = "bold")

ggsave(path=(paste0(filepath,"tables")), filename = "TabS7.svg", width=21, height=29.7, units = "cm")
ggsave(path=(paste0(filepath,"tables")), filename = "TabS7.pdf", width=21, height=29.7, units = "cm")
ggsave(path=(paste0(filepath,"tables")), filename = "TabS7.png", width=21, height=29.7, units = "cm", dpi=600)
