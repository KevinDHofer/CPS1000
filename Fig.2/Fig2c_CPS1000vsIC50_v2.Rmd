...
concentration_A <- rep(c(10, 2, 0.4, 0.08, 0.016), times = 10944)
...
concentration_B <- rep(c(2, 0.4, 0.08, 0.016, 0.0032), times = 16416)
...
concentration_C <- rep(c(0.4, 0.08, 0.016, 0.0032, 0.00064), times = 1368)
...
plot2 <- df_NA |> 
  ggplot(aes(normVal)) +
  geom_density(aes(fill=factor(new_bin)), alpha=0.3, linewidth=0.25) + 
